...
export const translations = {
    de: {
        ...
        legal: {
            ...
            responsible: 'Jannik Thieme, c/o IP-Management #11157, Ludwig-Erhard-Straße 18, 20459 Hamburg',
            section4Title: 'Haftungsausschluss',
            disclaimer1: 'Trotz sorgfältiger inhaltlicher Kontrolle übernehme ich keine Haftung für die Inhalte externer Links. Für den Inhalt der verlinkten Seiten sind ausschließlich deren Betreiber verantwortlich.',
            section5Title: 'Urheberrecht',
            copyright: 'Die durch den Seitenbetreiber erstellten Inhalte und Werke auf dieser Website unterliegen dem deutschen Urheberrecht. Die Vervielfältigung, Bearbeitung, Verbreitung und jede Art der Verwertung außerhalb der Grenzen des Urheberrechts bedürfen der schriftlichen Zustimmung des jeweiligen Autors.',
    ...
    en: {
        ...
        legal: {
            ...
            disclaimer1: 'Despite careful review, I accept no liability for the content of external links. The operators of linked pages are solely responsible for their content.',
            section5Title: 'Copyright',
            copyright: 'The content and works created by the site operator on this website are subject to German copyright law. Reproduction, editing, distribution, and any kind of use beyond the limits of copyright law require the written consent of the respective author.',
